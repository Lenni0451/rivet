...
public abstract class Theme {
    ...
    public static final ThemeKey<Float> BUTTON_OUTLINE_WIDTH = register("button.outline_width", Float.class, r -> roundMin(r.backend().getTextHeight() / 25F, 1));
    ...
    public static final ThemeKey<Float> SLIDER_BAR_HEIGHT = register("slider.bar_height", Float.class, r -> roundMin(r.backend().getTextHeight() / 3F, 1));
    public static final ThemeKey<Float> SLIDER_THUMB_WIDTH = register("slider.thumb_width", Float.class, r -> roundMin(r.backend().getTextHeight() / 3F, 1) * 2F);
    public static final ThemeKey<Float> SLIDER_THUMB_HEIGHT = register("slider.thumb_height", Float.class, r -> roundMin(r.backend().getTextHeight() / 3F, 1) * 2F);
    ...
    public static final ThemeKey<Float> SLIDER_TOOLTIP_TRIANGLE_SIZE = register("slider.tooltip_triangle_size", Float.class, r -> roundMin(r.backend().getTextHeight() / 4F, 1));
    ...
    public static final ThemeKey<Float> SCROLL_BAR_WIDTH = register("scroll.bar_width", Float.class, r -> roundMin(r.backend().getTextHeight() / 7F, 1));
    ...
    public static final ThemeKey<Float> SCROLL_SPEED = register("scroll.speed", Float.class, r -> roundMin(r.backend().getTextHeight() * 4, 1));
    ...
    public static final ThemeKey<Float> TEXT_FIELD_OUTLINE_WIDTH = register("text_field.outline_width", Float.class, r -> roundMin(r.backend().getTextHeight() / 25F, 1));
    ...
    public static final ThemeKey<Float> CHECKBOX_OUTLINE_WIDTH = register("checkbox.outline_width", Float.class, r -> roundMin(r.backend().getTextHeight() / 25F, 1));
    ...
    public static final ThemeKey<Float> COLOR_PICKER_PICKER_SIZE = register("color_picker.picker_size", Float.class, r -> roundMin(r.backend().getTextHeight() * 8F, 1));
    public static final ThemeKey<Float> COLOR_PICKER_SLIDER_WIDTH = register("color_picker.slider_width", Float.class, r -> roundMin(r.backend().getTextHeight(), 1));
    public static final ThemeKey<Float> COLOR_PICKER_GAP = register("color_picker.gap", Float.class, r -> roundMin(r.backend().getTextHeight() / 3F, 1));
    public static final ThemeKey<Float> COLOR_PICKER_SELECTOR_SIZE = register("color_picker.selector_size", Float.class, r -> roundMin(r.backend().getTextHeight() / 8F, 1));
    ...
    public static final ThemeKey<Float> SEPARATOR_THICKNESS = register("separator.thickness", Float.class, r -> roundMin(r.backend().getTextHeight() / 20F, 1));
